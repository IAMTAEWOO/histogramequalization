...
**320x240 프레임**에서 **1프레임 학습 → 8프레임 적용** 방식으로 **스트리밍 히스토그램 이퀄라이제이션**을 수행하는 **RTL IP 코어**입니다.
...
**상태 전이**:
```
IDLE → LEARN(1프레임) → LUTC(CDF→LUT) → STREAM(8프레임) → 반복
```
